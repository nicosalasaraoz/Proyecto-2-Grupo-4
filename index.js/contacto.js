function validarForm() {
    ...
    let textotres = document.getElementById('texto3').value
    if(textoUno === '' || textoDos === '' || textotres === '' ){
        ...
        document.getElementById ('texto3').className= 'form-control is-invalid'
    }else{
        ...
        document.getElementById('texto3').className = 'form-control is-valid'
    }}